    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown d-sm-inline-block">
            <a class="dropdown-item" href="https://akseslahan-sumsel.lahanuntukkehidupan.id/" target="_blank">Pembelajaran Pasca Izin PS</a>
          </li>
          @auth
          <li class="nav-item dropdown d-sm-inline-block">
          ...
          <li class="nav-item dropdown d-sm-inline-block">
            <a class="dropdown-item" href="https://akseslahan-sumsel.lahanuntukkehidupan.id/" target="_blank">Prasyarat Pengajuan</a>
          </li>
          @endauth
        </ul>
      </div>
