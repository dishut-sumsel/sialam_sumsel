...
<div class="">
    ...
    <div class="mb-3 bg-light rounded p-3" id="result-last">
        ...
        @if (strlen($proposal->step1_skemaps) && count(explode('-', $proposal->step1_skemaps)) == '1')
            ...
            Silakan lanjutkan proses pengajuan izin PS melalui laman <span class="txt-result-green"><a class="text-white" href="https://akseslahan-sumsel.lahanuntukkehidupan.id/" target="_blank">>>> Prasyarat Pengajuan >>></a></span>.
